    ...
    sources: {
        lift: {
            ...
            fileNames: [
                ...
                'Mzk0MzcwNDA5OF8xMDAwMDAwMzk=',
                'Mzk0MzcwNDA5OF8xMDAwMDAwNDA=',
                'Mzk0MzcwNDA5OF8xMDAwMDAwNDE='
            ]
        },
        burst: {
            volume: 1,
            ...
            playbackRateMax: 0.9,
            fileNames: [
                'Mzk0MzcwNDA5OF8xMDAwMDAwNDI=',
                'Mzk0MzcwNDA5OF8xMDAwMDAwNDM='
            ]
        },
        burstSmall: {
            volume: 0.25,
            ...
            playbackRateMax: 1,
            fileNames: [
                'Mzk0MzcwNDA5OF8xMDAwMDAwNDQ=',
                'Mzk0MzcwNDA5OF8xMDAwMDAwNDU='
            ]
        },
        crackle: {
            volume: 0.2,
            playbackRateMin: 1,
            playbackRateMax: 1,
            fileNames: ['Mzk0MzcwNDA5OF8xMDAwMDAwNDY=']
        },
        crackleSmall: {
            volume: 0.3,
            playbackRateMin: 1,
            playbackRateMax: 1,
            fileNames: ['Mzk0MzcwNDA5OF8xMDAwMDAwNDc=']
        }
    },
